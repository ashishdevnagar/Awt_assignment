...
<!-- HEYYYYYYYYYYYYYYYYYYYYYY-->
		...
		<div id="calbmi">
			...
			<form name="bmi">
				<center>
					<table bgcolor="#ffffff" border="2"  bordercolor="#ffba93" rules="none" cellspacing="0" cellpadding="4">
						...
						<td><input type="button" value="Calculate" style="background-color:#583d72; color:#9f5f80;" onClick="computeform(this.form)"></td></tr></div>
						<!--td><input type="reset" value = "Reset" onClick="ClearForm(this.form)"-->

						<tr><TD><DIV ALIGN=CENTER style="color:#ffba93;"><b> <i>Your BMI: </i> </b></DIV></TD>
							<TD><DIV ALIGN=CENTER style="color:#ffba93;"><b><i>My Comment:</i></b></DIV></TD></tr>
